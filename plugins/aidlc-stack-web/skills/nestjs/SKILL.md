...
messages}` module live in **`aidlc-stack-web:project-structure`** (`backend-nestjs`) — and a
...
Per-project ORM/ODM (TypeORM/Prisma/Mongoose — check package.json, follow `aidlc-stack-web:postgres` /
