...
This folder is the project's work-item tracker when `.claude/sdlc.config.json → workItems.source = "markdown"`.
It is read and written exclusively by the SDLC pipeline (`wi-markdown` adapter). Humans may add and edit items
