---
name: architecture
description: ADR triggers and format, design-review heuristics and the explore-before-deciding checklist for the SDLC design phase. Load when planning a medium-or-larger work item or making a hard-to-reverse technical decision.
...
- Contract changes are expand-contract, never break-and-fix (see `sdlc-stack-web:db-migrations` for the
