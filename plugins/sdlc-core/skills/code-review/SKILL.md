---
name: code-review
description: The SDLC code-review checklist, severity taxonomy and finding-report format used by the sdlc-reviewer agent in the verify phase. Load when reviewing a pipeline diff against acceptance criteria and standards.
