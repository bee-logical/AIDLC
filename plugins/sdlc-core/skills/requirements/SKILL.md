---
name: requirements
description: Acceptance-criteria quality bar, INVEST checklist and the assumption-logging protocol for the SDLC requirements phase. Load when validating, refining or writing acceptance criteria for a work item.
