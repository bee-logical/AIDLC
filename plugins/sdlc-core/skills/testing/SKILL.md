---
name: testing
description: SDLC test policy — the test pyramid, what to test per change type, coverage expectations and flaky-test protocol. Load when writing or evaluating tests during the verify phase.
