---
name: postgres
description: PostgreSQL conventions — schema design, indexing strategy, query patterns and review heuristics for the SDLC pipeline. Load when designing schemas, writing queries or reviewing Postgres-touching changes.
user-invocable: false
---

# PostgreSQL — conventions

Schema CHANGES always go through migrations (`sdlc-stack-web:db-migrations`) — this skill is how to
