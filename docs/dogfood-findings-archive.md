...
Continued dogfooding on the **Bee Logical Identity Platform** (poly + Azure DevOps + remote/PR). Where
...
- 2026-07-14 — Cycle 3 opened (next id F34).
- 2026-07-17 — Batch **F34–F40** drained from the Authentication inbox and implemented (reliability
  ...
  CI-parity recipe). Shipped at marketplace **0.18.0** and merged to `main` (`--no-ff` **d6a1eef**);
  inbox entries marked `pulled:F34–F40`.
- 2026-07-17 — **F41** (dogfood inbox pruning lifecycle) implemented, shipped at marketplace **0.18.1**
  and merged (`--no-ff` **743e75a**); the Authentication inbox was pruned of its shipped F34–F40
  entries. **Cycle 3 closed + archived here**; the living `dogfood-findings.md` reset fresh (next id
  **F42**).
